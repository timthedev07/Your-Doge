...
const TermsAndConditions: React.FC = () => {
  return (
    <div className="policies-container">
      ...
      <p>Welcome to Your Doge!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Your Doge&apos; Website, located at https://yourdoge.vercel.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Your Doge if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Your Doge, you agreed to use
        cookies in agreement with the Your Doge&apos; Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Your Doge and/or its licensors own the
        intellectual property rights for all material on Your Doge. All
        intellectual property rights are reserved. You may access this from Your
        Doge for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Your Doge</li>
        <li>Sell, rent or sub-license material from Your Doge</li>
        <li>Reproduce, duplicate or copy material from Your Doge</li>
        <li>Redistribute content from Your Doge</li>
      </ul>
      ...
      <p>
        ...
        of Your Doge,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Your Doge shall not be liable for
      ...
      <p>
        Your Doge reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Your Doge a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Your Doge; and (d) the link is
      ...
      <p>
        ...
        e-mail to Your Doge. Please include your name, your organization name,
      ...
      <p>
        No use of Your Doge&apos; logo or other artwork will be allowed for
