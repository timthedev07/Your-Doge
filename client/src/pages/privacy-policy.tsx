...
const PrivacyPolicies: React.FC = ({}) => {
  return (
    <div className="policies-container">
      ...
      <p>
        At Your Doge, accessible from https://yourdoge.vercel.app, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Your Doge and how we use it.
      </p>
      ...
      <p>
        Your Doge follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Your Doge uses &apos;cookies&apos;. These
      ...
      <p>
        ...
        advertising partners of Your Doge.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Your Doge, which are sent
      ...
      <p>
        Note that Your Doge has no access to or control over these cookies that
      ...
      <p>
        Your Doge&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Your Doge does not knowingly collect any Personal Identifiable
